...
In the server-side rendering mode, __webpack-dev-middleware__ would set the `stat` to `res.locals.webpackStats` before invoking the next middleware, where we can render pages and the response to clients.
