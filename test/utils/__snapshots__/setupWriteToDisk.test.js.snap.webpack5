...
exports[`setupWriteToDisk tries to create directories and write file if not filtered out with mkdir error 2`] = `[]`;
...
exports[`setupWriteToDisk tries to create directories and write file if not filtered out with no write errors 1`] = `[]`;
...
exports[`setupWriteToDisk tries to create directories and write file if not filtered out with writeFile error 2`] = `[]`;
