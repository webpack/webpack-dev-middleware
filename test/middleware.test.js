...
const frameworks = [
  {
    name: 'fastify',
    framework: fastify,
    defaultErrorContentTypeHeader: 'application/json; charset=utf-8',
    defaultContentHeader: 'application/octet-stream',
    defaultHeader: 'text/plain; charset=utf-8',
  },
  {
    name: 'express',
    framework: express,
    defaultErrorContentTypeHeader: 'text/html; charset=utf-8',
    defaultContentHeader: 'text/html; charset=utf-8',
    defaultHeader: 'text/html; charset=utf-8',
  },
];

const setupMiddleware = (frameworkObject, app, ...middleware) => {
  if (frameworkObject.name === 'fastify') {
    app.register(middie).then(() => app.use(middleware));
  } else {
    app.use(middleware);
  }
};
  ...
  describe(`middleware (${frameworkObject.name})`, () => {
    ...
    describe('basic', () => {
      describe('should work', () => {
        ...
        beforeAll((done) => {
          ...
          setupMiddleware(frameworkObject, app, instance);
        ...
        it('should return the "404" code for the "POST" request to the bundle file', (done) => {
          request(server).post('/bundle.js').expect(404, done);
        });
        ...
        it('should return the "404" code for the "GET" request with to the non-public path', (done) => {
          request(server)
            ...
            .expect(
              'Content-Type',
              frameworkObject.defaultErrorContentTypeHeader
            )
            .expect(404, done);
        });
      ...
      describe('should not work with the broken "publicPath" option', () => {
        ...
        it('should return the "400" code for the "GET" request to the bundle file', (done) => {
          request(server).get('/bundle.js').expect(404, done);
        });
      });
      ...
      describe('should work in multi-compiler mode', () => {
        ...
        it('should return "200" code for GET request to the bundle file for the first compiler', (done) => {
          request(server).get('/static-one/bundle.js').expect(200, done);
        });

        it('should return "404" code for GET request to a non existing file for the first compiler', (done) => {
          request(server).get('/static-one/invalid.js').expect(404, done);
        });
        ...
        const fixtures = [
          {
            urls: [
              ...
              {
                value: 'invalid.js',
                contentType: frameworkObject.defaultErrorContentTypeHeader,
                code: 404,
              },
              {
                value: 'complex',
          ...
          },
          {
            file: '/%foo%/%foo%.js',
            data:
              frameworkObject.name === 'fastify'
                ? false
                : 'console.log("foo");',
            urls: [
              // Filenames can contain characters not allowed in URIs only valid in express
              {
                value: '%foo%/%foo%.js',
                contentType:
                  frameworkObject.name === 'fastify'
                ...
                code: frameworkObject.name === 'fastify' ? 404 : 200,
              },
            ],
          },
          {
      ...
      describe('should respect the value of the "Content-Type" header from other middleware', () => {
        beforeAll((done) => {
          ...
          app = frameworkObject.framework();
          setupMiddleware(frameworkObject, app, testMiddleware, instance);
      ...
      describe('should work without "output" options', () => {
        ...
        it('should return "200" code for GET request to the bundle file', (done) => {
          request(server).get('/main.js').expect(200, done);
        });

        it('should return "404" code for GET request to a nonexistent file', (done) => {
          request(server).get('/invalid.js').expect(404, done);
        });
      ...
      describe('should work with trailing slash at the end of the "option.path" option', () => {
        ...
        it('should return "200" code for GET request to the bundle file', (done) => {
          request(server).get('/bundle.js').expect(200, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options', () => {
        ...
        it('should return "200" code for GET request to the bundle file', (done) => {
          request(server).get('/static/bundle.js').expect(200, done);
        });

        it('should return "404" code for GET request to a nonexistent file', (done) => {
          request(server).get('/static/invalid.js').expect(404, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options with hash substitutions', () => {
        ...
        it('should return "200" code for GET request to the bundle file', (done) => {
          request(server).get(`/static/${hash}/bundle.js`).expect(200, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options in multi-compiler mode with hash substitutions', () => {
        ...
        it('should return "404" code for GET request to the "public" path for the second compiler', (done) => {
          request(server).get(`/static-two/${hashTwo}/`).expect(404, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options in multi-compiler mode with same "publicPath"', () => {
        ...
        it('should return "200" code for GET request to the bundle file for the first compiler', (done) => {
          request(server).get('/my-public/bundle-one.js').expect(200, done);
        });

        it('should return "200" code for GET request to the bundle file for the second compiler', (done) => {
          request(server).get('/my-public/bundle-two.js').expect(200, done);
        });

        it('should return "404" code for GET request to nonexistent file', (done) => {
          request(server).get('/my-public/invalid.js').expect(404, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options in multi-compiler mode with same "path"', () => {
        ...
        it('should return "200" code for GET request to the bundle file for the first compiler', (done) => {
          request(server).get('/one-public/bundle-one.js').expect(200, done);
        });

        it('should return "404" code for GET request to nonexistent file to the first bundle file', (done) => {
          request(server).get('/one-public/invalid.js').expect(404, done);
        });
        ...
        it('should return "200" code for GET request to the bundle file for the second compiler', (done) => {
          request(server).get('/two-public/bundle-two.js').expect(200, done);
        });

        it('should return "404" code for GET request to nonexistent file to the second bundle file', (done) => {
          request(server).get('/two-public/invalid.js').expect(404, done);
        });
      ...
      describe('should respect "output.publicPath" and "output.path" options in multi-compiler mode, when the "output.publicPath" option presented in only one configuration with same "path"', () => {
        ...
        it('should return "200" code for GET request to the bundle file', (done) => {
          request(server).get('/static/bundle-one.js').expect(200, done);
        });
        ...
        it('should return "404" code for GET request to the public path', (done) => {
          request(server).get('/static/').expect(200, done);
        });
    ...
    describe('mimeTypes option', () => {
      ...
      describe('should set the correct value for "Content-Type" header to unknown MIME type', () => {
        ...
        it('should return the "200" code for the "GET" request to "file.phtml"', (done) => {
          request(server)
            .get('/file.phtml')
            .expect('Content-Type', frameworkObject.defaultContentHeader)
            .expect(200, done);
        });
      });
      ...
      describe('should not set "Content-Type" header for route not from outputFileSystem', () => {
        ...
        it('should return the "200" code for the "GET" request "file.jpg" with default content type', (done) => {
          request(server)
            .get('/file.jpg')
            .expect('Content-Type', frameworkObject.defaultHeader)
            .expect(200, done);
        });
      });
    });
    ...
    describe('methods option', () => {
      ...
      it('should return the "200" code for the "POST" request to the bundle file', (done) => {
        request(server).post('/public/bundle.js').expect(200, done);
      });

      it('should return the "404" code for the "GET" request to the bundle file', (done) => {
        request(server).get('/public/bundle.js').expect(404, done);
      });

      it('should return the "200" code for the "HEAD" request to the bundle file', (done) => {
        request(server).head('/public/bundle.js').expect(404, done);
      });
    });
    ...
    describe('headers option', () => {
      ...
      it('should return the "200" code for the "GET" request to path not in outputFileSystem but not return headers', async () => {
        const res = await request(server).get('/file.jpg');
    ...
    describe('publicPath option', () => {
      describe('should work with "string" value', () => {
        ...
        it('should return the "200" code for the "GET" request to the bundle file', (done) => {
          request(server).get('/public/bundle.js').expect(200, done);
        });
      });
    });
    ...
    describe('serverSideRender option', () => {
      ...
      beforeAll((done) => {
        ...
        app = frameworkObject.framework();
        setupMiddleware(frameworkObject, app, instance, testMiddleware);
        server = frameworkObject.name === 'fastify' ? app.server : app;
